...
%>		
      ...
      <tr>
		...
		<td><input type="checkbox" value="<%=obj_Variable_Order.getName() %>" name="name" onChange="this.form.submit()">Accounting</td>
        <td><input onclick="return false" checked type="checkbox">QCG</td>
        <td><input type="checkbox" value="<%=obj_Variable_Order.getUsername()%>" name="username" onChange="this.form.submit()">FDG</td>
        <td><a class="view" href="/IMS/ACCOUNT/Accounts3.jsp?username=<%=obj_Variable_Order.getUsername() %>"">Delete</a></td>
      </tr>
    </form>
...
%>	
      ...
      <tr>
		...
		<td><%=obj_Variable_Order.getEmail() %></td>
		<td><input type="checkbox" value="<%=obj_Variable_Order.getName() %>" name="name" onChange="this.form.submit()">Accounting</td>
        <td><input type="checkbox" value="<%=obj_Variable_Order.getContactNumber()%>" name="contactNumber" onChange="this.form.submit()">QCG</td>
